...
describe('Event component',() =>{
    it('render event without errors', () =>{
        const testData: IEvent ={id: 2, name: 'test', joined: true, location: 'GBG', time: '2022-02-14', comments : ['kommentar', 'en till']}
        render(<Event event={testData} />)
    })

    it('Renders event name, location and time' , () => {
        const testData: IEvent ={id: 2, name: 'test', joined: true, location: 'GBG', time: '2023-05-15', comments : ['kommentar', 'en till']}
